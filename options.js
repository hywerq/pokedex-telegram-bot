export const startOptions = {
    reply_markup: JSON.stringify({
        inline_keyboard: [
            ...
            [{ text: '\u{1F524} Text commands', callback_data: '1'}, { text: '\u{1F4AC} Voice commands', callback_data: '1'}]
        ]
    })
}
...
export const itemOptions = {
    reply_markup: JSON.stringify({
        inline_keyboard: [
            [{ text: '\u{1F9F3} Find item', callback_data: 'berry'}],
            [{ text: `\u{1F9F3} All items by attribute`, callback_data: 'firmness'}]
        ]
    })
}
